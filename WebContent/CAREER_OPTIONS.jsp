...
<!-- what we do -->
	...
	<div class="container">
		...
		<h3 class="w3l_header">Career Options</h3>
				<p>Some broad categories of the career options. Click on them to know more about them.</p>
							</div>
			<%@page import="java.io.*" %>
			...
			<%
				...
				String query = "SELECT * FROM category WHERE ch_1='Yes';";
				ResultSet RS = st.executeQuery(query);
				int i=1;
				String cid= "";
				while(RS.next())
				{  cid= RS.getObject(1).toString();
			...
			<div class="row about-info-grids" style="margin-bottom:20px">
				<%
					...
					out.println("<input id=\"id\" type=\"hidden\" value="+cid+">");
					if(email==null)
