...
<body>
	<jsp:include page="headerAdmin.jsp">
		<jsp:param value="Lesson Management Page" name="pname"/>
	</jsp:include>
	...
	<%
		...
		while(RS.next())
		{
			catid=RS.getObject(4).toString();
			Statement st1 = con.createStatement();
			String query1 = "SELECT Name FROM total_courses WHERE Course_ID='" + catid + "'";
			ResultSet RS1 = st1.executeQuery(query1);
			RS1.next();
			out.println("<tr>");
			out.println("<td>"+i+"</td>");
			out.println("<td id=\"trid\" class=\"font-size:12px;\">"+RS.getObject(1).toString()+"</td>");
			...
			out.println("<td><div class=\"col-md-6 button_set_one three one agile_info_shadow\" style=\"padding-right: 0px;padding-left: 0px;border-top-width: 0px;border-left-width: 0px;border-bottom-width: 0px;border-right-width: 0px;\"><a class=\"readmore admission\" href=\"dellesson.jsp?ID="+RS.getString(1)+"\" style=\"color:#fff\"><button type=\"button\" class=\"btn btn-primary btn-flat btn-pri btn-lg\" style=\"padding-right: 20px;padding-left: 20px;padding-top: 5px;padding-bottom: 5px;\" onclick=\"myfunc()\"> Delete </button></a><br><a class=\"readmore admission\" href=\"edlesson.jsp?ID="+RS.getString(1)+"\" style=\"color:#fff\"><button type=\"button\" id=\"but\" class=\"btn btn-primary btn-flat btn-pri btn-lg\" style=\"padding-right: 20px;padding-left: 20px;padding-top: 5px;padding-bottom: 5px;\"> Edit</button></a></div></td>");
			out.println("</tr>");
			i++;
		%>
<script type="text/javascript">
	...
	<%
		...
		if(s.length()==1)
			s="000"+s;
		s="L"+s;
		String query1 = "SELECT * FROM total_courses";
		ResultSet RS2 = st.executeQuery(query1);
	%>
	<!-- popup for sign up form -->
<div class="modal video-modal fade" id="myModal14" tabindex="-1" role="dialog" aria-labelledby="myModal2">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div id="small-dialog2" class="mfp-hide book-form">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h3 style="margin-bottom:15px;">Add Lesson</h3>
					<form action="addlesson.jsp" method="post">
						...
						<input type="url" name="URL" class="i" placeholder="URL" required=""/>
						<div class="select-block1">
							<select class="s" name="Course" required="">
