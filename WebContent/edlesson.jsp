			...
			<div class="modal video-modal fade in" id="myModal15" tabindex="-1" role="dialog" aria-labelledby="myModal2" aria-hidden="false" style="display:block">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<a href="adlesson.jsp"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></a>
							<h3 style="margin-bottom:15px;">Edit Lesson</h3>
								<form action="editlesson.jsp" method="post">
									<input type="text" id="eid" name="ID" placeholder="ID" class="i" value="<%=ID %>" required="" readonly/>
									<input type="text" name="Name" class="i" placeholder="Name" pattern="(?=.*[a-z])(?=.*[A-Z]).{,100}" title="Only Characters" value="<%=RS.getString(2) %>" required=""/>
									<input type="url" name="URL" class="i" placeholder="URL" value="<%=RS.getString(3) %>" required=""/>
