...
<title>My Courses | CareerWay</title>
<style type="text/css">
#myDiv:hover {
              cursor:pointer;
	...
	<div class="container c">
		<div class="wthree_head_section">
			...
			<%
				...
				String query="SELECT * FROM enroll WHERE email='"+email+"';";
				ResultSet RS1 = st.executeQuery(query);
				String q;
				ResultSet RS;
			%>
			<h3 class="w3l_header">Enrolled Courses</h3>
			   <p>These are the online courses that you have enrolled for, now you can start taking lessons. Click on them to know about them</p>
			</div>
				
			<% 	
				while(RS1.next())
				{  
					q="SELECT * FROM total_courses WHERE Course_ID='"+RS1.getString(2)+"';";
			...
			<div class="row about-info-grids" style="margin-bottom:20px;">
				<%
					...
					out.println("<h4><a href=\"COURSES_DETAILS.jsp?email="+email+"&ID="+RS.getObject(1).toString()+"\">"+RS.getObject(2).toString()+"</a></h4>");
					out.println("<table>");
					out.println("<tr><td>Suitable For</td><td>"+RS.getString(6).toString()+"</td></tr>");
					out.println("<tr><td>Level</td><td>"+RS.getString(3).toString()+"</td></tr>");
					out.println("<tr><td>Expected Time</td><td>"+RS.getString(4).toString()+"</td></tr>");
					out.println("</table>");
					out.println("</div>");
					if(RS1.next())
					{
