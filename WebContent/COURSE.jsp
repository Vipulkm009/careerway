	...
	<div class="container c">
		<div class="wthree_head_section">
			...
			<%
				...
				if(CID==null)
				{
					query = "SELECT * FROM total courses;";
				}
				else
				{
					query = "SELECT * FROM total_courses WHERE Cat_ID='"+CID+"';";
				}
				ResultSet RS = st.executeQuery(query);
			%>
			<h3 class="w3l_header">Online Courses</h3>
			   <p>These are some online courses that we are providing. You can enroll for them and start taking lessons. Click on them to know about them</p>
			</div>
