...
%>
		...
		<%
	    		...
	    		String key[]=s.split(" ");
	    		String q1="SELECT * FROM career";
	    		String q2="SELECT * FROM category";
	    		String q3="SELECT * FROM total_courses";
	    		ResultSet RS=st.executeQuery(q2);
	    %>
<section class="what_you">
	<div class="container">
	<div class="wthree_head_section">
		<h3 class="w3l_header">Search for <%=s %></h3>
				<p> Click on them to know more about them.</p>
							</div>
		<div class="row about-info-grids" style="margin-bottom:20px">
		<div class="col-md-4"><h4 style="text-align:left;">Categories found-</h4></div>
	    ...
	    %>
				<%
					...
					if(email==null)
						out.println("<h4><a href= \"Career_Details.jsp?ID="+RS.getObject(1).toString()+"&XID="+RS.getObject(2).toString()+"\">"+RS.getObject(2).toString()+"</a></h4>");
					else
						out.println("<h4><a href= \"Career_Details.jsp?email="+email+"&ID="+RS.getObject(1).toString()+"&XID="+RS.getObject(2).toString()+"\">"+RS.getObject(2).toString()+"</a></h4>");
					out.println("<div class=\"h4-underline\"></div>");
					out.println("<p>"+RS.getObject(3).toString() +"</p>");
					out.println("</div>");
					c=2;
					}
					else if(c==2)
	    ...
	    <div class="row about-info-grids" style="margin-bottom:20px">
	    <div class="col-md-4"><h4 style="text-align:left;">Careers found-</h4></div>
	    <div class="col-md-4"></div>
	    <div class="col-md-4"></div>
	    <%
	    ...
	    %>
				<%
					...
					out.println("<i class=\"fas fa-book\"></i>");
					if(email==null)
						out.println("<h4><a href= \"Guidance.jsp?ID="+RS.getObject(1).toString()+"&XID="+RS.getObject(2).toString()+"&CID="+RS.getString(3)+"\">"+RS.getObject(2).toString()+"</a></h4>");
					else
						out.println("<h4><a href= \"Guidance.jsp?email="+email+"&ID="+RS.getObject(1).toString()+"&XID="+RS.getObject(2).toString()+"&CID="+RS.getString(3)+"\">"+RS.getObject(2).toString()+"</a></h4>");
					out.println("<div class=\"h4-underline\"></div>");
