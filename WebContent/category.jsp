...
<title>Category Management | Admin Panel | CareerWay</title>
<!-- custom-theme -->
...
<body>
	<jsp:include page="headerAdmin.jsp">
		<jsp:param value="Category Management Page" name="pname"/>
	</jsp:include>
	<table class="table table-striped table-hover table-responsive" style="padding-top:50pxx;">
		<tr>
			...
			<th>Description</th>
			<th>Science</th>
			<th>Categories with Career Option</th>
			<th>Action</th>
		</tr>
		<tr>
			<td></td>
	...
	<%
		...
		while(RS.next())
		{
			...
			out.println("<td><div class=\"col-md-6 button_set_one three one agile_info_shadow\" style=\"padding-right: 0px;padding-left: 0px;border-top-width: 0px;border-left-width: 0px;border-bottom-width: 0px;border-right-width: 0px;\"><a class=\"readmore admission\" href=\"delcategory.jsp?ID="+RS.getString(1)+"\" style=\"color:#fff\"><button type=\"button\" class=\"btn btn-primary btn-flat btn-pri btn-lg\" style=\"padding-right: 20px;padding-left: 20px;padding-top: 5px;padding-bottom: 5px;\"> Delete </button></a><br><a class=\"readmore admission\" href=\"#\" data-toggle=\"modal\" data-target=\"#myModal15\" style=\"color:#fff\"><button type=\"button\" class=\"btn btn-primary btn-flat btn-pri btn-lg\" style=\"padding-right: 20px;padding-left: 20px;padding-top: 5px;padding-bottom: 5px;\"> Edit</button></a></div></td>");
			out.println("</tr>");
			i++;
		}
	%>
				...
				<p style="text-align:center;margin-bottom:15px;">** fields must use '&' to separate different values of a particular column.</p>
					<form action="addcategory.jsp" method="post">
						...
						<div class="select-block1">
							<select class="s" name="Science" required="">
						...
						<div class="select-block1">
							<select class="s" name="ch1" required="">
								<option value="">Select*</option>
								<option>Yes</option>
								<option>No</option>
							</select>
