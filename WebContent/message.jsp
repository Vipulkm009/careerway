...
<title>Message | Admin Panel | CareerWay</title>
<!-- custom-theme -->
...
<link href="css2/message.css" rel="stylesheet" type="text/css" media="all" />
<style type="text/css">
td {
	font-size: 12px;
}
...
<jsp:include page="headerAdmin.jsp"></jsp:include>
	...
	<%
		...
		while(RS.next())
		{
			...
			out.println("<td><div class=\"contact-middle\"><form action=\"reply.jsp\" method=\"post\"><input type=\"hidden\" name=\"comment\" value=\""+RS.getString(3)+"\"></input><input type=\"hidden\" name=\"date\" value=\""+RS.getString(4)+"\"></input><textarea name=\"txtComments\" placeholder=\"Your Comment\" required=\"\"></textarea><input type=\"submit\" value=\"Reply\"></form></div></td>");
			out.println("</tr>");
			i++;
		}
	%>
