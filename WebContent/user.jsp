...
<title>User Management | Admin Panel | CareerWay</title>
<!-- custom-theme -->
...
<jsp:include page="headerAdmin.jsp">
	<jsp:param value="User Management Page" name="pname"/>
</jsp:include>
	...
	<%
		...
		while(RS.next())
		{
			status=Boolean.parseBoolean(RS.getString(8).toString());
			out.println("<tr>");
			out.println("<td>"+i+"</td>");
			out.println("<td>"+RS.getObject(1).toString()+"</td>");
			out.println("<td>"+RS.getObject(2).toString()+"</td>");
			out.println("<td>"+RS.getObject(3).toString()+"</td>");
			out.println("<td>"+RS.getObject(8).toString()+"</td>");
			out.println("<td>"+RS.getObject(4).toString()+"</td>");
			out.println("<td>"+RS.getObject(5).toString()+"</td>");
			out.println("<td>"+RS.getObject(6).toString()+"</td>");
			out.println("<td>"+RS.getObject(7).toString()+"</td>");
			if(status)
			{
				out.println("<td><div class=\"col-md-6 button_set_one three one agile_info_shadow\" style=\"padding-right: 0px;padding-left: 0px;border-top-width: 0px;border-left-width: 0px;border-bottom-width: 0px;border-right-width: 0px;\"><a href=\"enable-disable.jsp?ID="+RS.getString(3)+"&st1=true\"><button type=\"button\" class=\"btn btn-primary btn-flat btn-pri btn-lg\" style=\"padding-right: 20px;padding-left: 20px;padding-top: 5px;padding-bottom: 5px;\" disabled>Enable</button></a><a href=\"enable-disable.jsp?ID="+RS.getString(3)+"&st1=false\"><button type=\"button\" class=\"btn btn-primary btn-flat btn-pri btn-lg\" style=\"padding-right: 20px;padding-left: 20px;padding-top: 5px;padding-bottom: 5px;\">Disable</button></a></div></td>");
			}
			else
			{
				out.println("<td><div class=\"col-md-6 button_set_one three one agile_info_shadow\" style=\"padding-right: 0px;padding-left: 0px;border-top-width: 0px;border-left-width: 0px;border-bottom-width: 0px;border-right-width: 0px;\"><a href=\"enable-disable.jsp?ID="+RS.getString(3)+"&st1=true\"><button type=\"button\" class=\"btn btn-primary btn-flat btn-pri btn-lg\" style=\"padding-right: 20px;padding-left: 20px;padding-top: 5px;padding-bottom: 5px;\">Enable</button></a><a href=\"enable-disable.jsp?ID="+RS.getString(3)+"&st1=false\"><button type=\"button\" class=\"btn btn-primary btn-flat btn-pri btn-lg\" style=\"padding-right: 20px;padding-left: 20px;padding-top: 5px;padding-bottom: 5px;\" disabled>Disable</button></a></div></td>");
			}
			out.println("</tr>");
			i++;
		}
