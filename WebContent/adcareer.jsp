...
<title>Career Management | Admin Panel | CareerWay</title>
<!-- custom-theme -->
...
<body>
	<jsp:include page="headerAdmin.jsp">
		<jsp:param value="Career Management Page" name="pname"/>
	</jsp:include>
	...
	<%
		...
		while(RS.next())
		{
			...
			out.println("<td class=\"font-size:12px;\">"+RS.getObject(10).toString()+"</td>");
			out.println("<td><div class=\"col-md-6 button_set_one three one agile_info_shadow\" style=\"padding-right: 0px;padding-left: 0px;border-top-width: 0px;border-left-width: 0px;border-bottom-width: 0px;border-right-width: 0px;\"><a class=\"readmore admission\" href=\"delcareer.jsp?ID="+RS.getString(1)+"\" style=\"color:#fff\"><button type=\"button\" class=\"btn btn-primary btn-flat btn-pri btn-lg\" style=\"padding-right: 20px;padding-left: 20px;padding-top: 5px;padding-bottom: 5px;\"> Delete </button></a><br><a class=\"readmore admission\" href=\"#\" data-toggle=\"modal\" data-target=\"#myModal15\" style=\"color:#fff\"><button type=\"button\" class=\"btn btn-primary btn-flat btn-pri btn-lg\" style=\"padding-right: 20px;padding-left: 20px;padding-top: 5px;padding-bottom: 5px;\"> Edit</button></a></div></td>");
			out.println("</tr>");
			i++;
		}
	%>
		...
		<div class="modal-content">
			...
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				...
				<p style="text-align:center;margin-bottom:15px;">** fields must use '&' to separate different values of a particular column.</p>
					<form action="addcareer.jsp" method="post">
						<input type="text" name="ID" placeholder="ID" class="i" value="<%=s %>" required="" readonly/>
						<input type="text" name="Name" class="i" placeholder="Name" pattern="(?=.*[a-z])(?=.*[A-Z]).{,100}" title="Only Characters" required=""/>
						...
						<textarea name="Description" placeholder="Description" class="i" required=""/></textarea>
						<textarea name="School" placeholder="School**" class="i" required=""/></textarea>
						<textarea name="College" placeholder="College**" class="i" required=""/></textarea>
						<textarea name="Entrance Exams" placeholder="Entrance Exams**" class="i" required=""/></textarea>
						<textarea name="Job Description" placeholder="Job Description" class="i" required=""/></textarea>
						<textarea name="Extras" placeholder="Extras**" class="i" required=""/></textarea>
						<textarea name="Subjects" placeholder="Subjects**" class="i" required=""/></textarea>
...
<!-- //popup for sign up form -->
<!-- popup for sign up form -->
<div class="modal video-modal fade d" id="myModal15" tabindex="-1" role="dialog" aria-labelledby="myModal2">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div id="small-dialog2" class="mfp-hide book-form">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
